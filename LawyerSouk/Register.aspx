<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Home1" %>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto text-center">
					...
					<li class="nav-item  mr-lg-3">
						<a class="nav-link" href="about.html">About EPP </a>
					</li>
					<li class="nav-item  mr-lg-3">
						<a class="nav-link" href="jobs.html">Companies</a>
					</li>
					<li class="nav-item">
				...
				<div class="w3layouts-banner-top w3layouts-banner-top2">
					<div class="bs-slider-overlay">
						<div class="container">
							<!-- Slide Text Layer -->
							<div class="w3l-slide-text text-center">
								<h3 class="text-uppercase pt-4 pb-3">THE ONLY WAY TO DO GREAT WORK IS <br>TO LOVE WHAT YOU DO.</h3>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container-fluid py-lg-5 py-3">
		<div class="row about_grids">
			<div class="col-lg-4 col-md-6 team_grid1">
				...
				<p>Our mission is to help people get contract base jobs once the contract is over or before it.</p>
				<p class="second_para"> Keeping employees engaged and satisfied takes more than just good pay and benefits.
.</p>
			</div>
			...
			<div class="col-lg-5 col-md-12 about-right mt-lg-0 mt-5 pl-lg-5">
				<div id="horizontalTab">
					...
					<div class="resp-tabs-container">
						<div class="tab1">
							<h4 class="">It will provide online contract base Company can request for an interview to user..</h4>
							<p class="">Job hunting, job seeking, or job searching is the act of looking for employment,</p>
						</div>
						<div class="tab2">
...
<p>Does more than asked. While getting the work done and doing your fair share is expected of good team players, great team players know that taking risks.
		...
		<div class="col-lg-2 col-md-3 col-6 mb-md-0 mb-5 w3l_team_grid">
			...
			<h4 class="my-2">Ashish Panchal</h4>
			<p></p>
		</div>
		<div class="col-lg-2 col-md-3 col-6 mb-md-0 mb-5 w3l_team_grid">
			<div class="view view-second">
			...
			<h4 class="my-2">Krishna Sadafale</h4>
		</div>
		<div class="col-lg-2 col-md-3 col-6 w3l_team_grid">
			<div class="view view-second">
				<img src="images/t3.jpg" alt=" " class="img-fluid" />
			</div>
			<h4 class="my-2">Vishal Panchal</h4>
			<p></p>
		</div>
		<div class="col-lg-2 col-md-3 col-6 w3l_team_grid">
			<div class="view view-second">
