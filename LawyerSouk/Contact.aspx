<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Home1" %>
		...
		<div class="container-fluid pt-lg-5">
			<div class="row contact-grids">
				<div class="col-lg-4 col-12 mb-lg-0 mb-sm-4 mb-3 team_grid1">
					<h4 class="heading text-uppercase">Contact Us</h4>
					<p>If you have any questions for The Lawyer Souk Portal, we are always happy to help...</p>
					<p class="second_para">
						The Lawyer Souk – Building on a Successful Track Record.
					</p>
				</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-4 map">
					<iframe width="520" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20Vadodara+()&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='https://www.horando.de/en/'>India</a>
