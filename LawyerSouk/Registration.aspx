<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Home1" %>
...
<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title text-uppercase" id="exampleModalLabel1">LAWYER SOUK Client Register Form </h5>
				...
				<div class="modal-body">
						<div class="form-group">
							 <asp:Button ID="btncp" runat="server" Text="For Lawyer Register Click Here" class="form-control"  BackColor="Tomato"
                            CausesValidation="false" onclick="btncp_Click" Width="246px"
                                    />	
							<label for="recipient-nameid" class="col-form-label">ClientId</label>
...
<div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
							<label for="recipient-name" class="col-form-label">UploadImage</label>
                             <asp:FileUpload ID="addimage" runat="server"  class="form-control" />
                             <asp:RequiredFieldValidator
                                 ID="RequiredFieldValidator4" runat="server" 
                                 ErrorMessage="UploadPassportSizePhoto" ControlToValidate="addimage" 
