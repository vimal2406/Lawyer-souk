 <%@ Page Title="" Language="C#" MasterPageFile="~/Lawyer.master" AutoEventWireup="true" CodeFile="ViewBookLawyerAppointment.aspx.cs" Inherits="UserHome" %>
                ...
                <table style="border-style: solid;  width: 100%; height: 289px; ">
                    <tr>
                        <td class="style79" colspan="2">
                             <span class="auto-style5"><strong>View Book an appointment With Lawyer&nbsp; </strong></span>
                           <hr />
                             </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" class="auto-style3">
                            <asp:TextBox ID="txtRDate" class="form-control"  onkeypress="return character(event)" placeholder="Full Name" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style4">
                    ...
                    <tr>
                        <td class="auto-style4" style="text-align: left">
							Accept/Reject Appointment:</td>
                        <td style="text-align: left" class="auto-style3">
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="17px" Width="106px">
                    ...
                    <tr>
                        <td class="auto-style4">
                        <asp:Button ID="Button1" runat="server" Text="Update Appointment Status" class="form-control" CausesValidation="true" 
