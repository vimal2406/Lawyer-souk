<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LawyerLogin.aspx.cs" Inherits="Home1" %>
...
<label for="recipient-name1" class="col-form-label">Password</label>
					...
					<hr />
                            ...
                            Text="ClientLogin" CausesValidation="false" onclick="Button1_Click" ></asp:Button>
